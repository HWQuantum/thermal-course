...
Schematic illustration of the entropy mixing simulation.
```
...
2. Set the total number of time steps $T$ (e.g. 10,000), set the number of bins $B$ for entropy calculation (e.g. 2, 4, or 8), and initialise a vector of length $T$ to store entropy values $S$.
